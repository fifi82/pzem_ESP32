...
/*##################################################  sychro_heure_web ###################################################*/
 void sychro_heure_web(){ // calcul de l'heure d'été et heure d'hiver
  ...
  lecture_heure_web();  // lecture de l'heure avec correction été hiver
 }
